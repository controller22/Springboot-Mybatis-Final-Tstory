    ...
    <div class="my_auth_box">
        <div class="my_auth_form_box" style="width: 700px">
            ...
            <div style="display: flex">
                ...
                <input class="my_auth_form_box_input" type="text" maxlength="20" value="${category.categoryTitle}" required readonly/>
            </div>
            <div style="display: flex">
                <div class="my_auth_form_box_info_security_detail" style="width: 200px">
                    변경할 카테고리명
                </div>
                <input id="categoryTitle" oninput="checkCategoryTitle();validCategoryTitle();" class="my_auth_form_box_input" type="text" maxlength="20" required/>
            </div>
            <span
