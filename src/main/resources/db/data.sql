INSERT INTO user_tb(username, password, email, nickname, profile_img , role, updated_at,created_at) VALUES('ssar','1234','ssar@nate.com', 'ssar','기본프로필사진.jpg','user',NOW(), NOW());
